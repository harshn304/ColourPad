...
/////////////////////////  
FileOperation(ColourPad npd)  
{  
this.npd=npd;  
  
saved=true;  
newFileFlag=true;  
fileName=new String("Colour");  
...
/************************************/  
public class ColourPad implements ActionListener, MenuConstants  
{  
...
JComponent fontDialog=null;  
//JFindDialog findReplaceDialog=null;   
...
{  
if(ColourPad.this.ta.getText().length()==0)  
    return; // text box have no text  
//if(findReplaceDialog==null)  
//    findReplaceDialog=new FindDialog(ColourPad.this.ta);  
//findReplaceDialog.showDialog(ColourPad.this.f,true);//find  
}  
////////////////////////////////////  
...
//if(findReplaceDialog==null)  
//    findReplaceDialog=new FindDialog(ColourPad.this.ta);  
//findReplaceDialog.showDialog(ColourPad.this.f,false);//replace  
}  
////////////////////////////////////  
...
//if(fontDialog.;
//    ColourPad.this.ta.setFont(fontDialog.createFont());  
}  
////////////////////////////////////  
...
////////////////////////////////////  
else if(cmdText.equals(helpAboutColourPad))  
{  
JOptionPane.showMessageDialog(ColourPad.this.f,aboutText,"Dedicated 2 u!",  
JOptionPane.INFORMATION_MESSAGE);  
}  
else  
...
if(backgroundDialog==null)  
    backgroundDialog=JColorChooser.createDialog  
        ...
        {public void actionPerformed(ActionEvent evvv){  
            ColourPad.this.ta.setBackground(bcolorChooser.getColor());}},  
        null);        
...
if(foregroundDialog==null)  
    foregroundDialog=JColorChooser.createDialog  
        ...
        new ActionListener()  
        {public void actionPerformed(ActionEvent evvv){  
            ColourPad.this.ta.setForeground(fcolorChooser.getColor());}},  
        null);        
...
createMenuItem(helpAboutColourPad,KeyEvent.VK_A,helpMenu,this);  
...
{  
   public void menuSelected(MenuEvent evvvv)  
    ...
    if(ColourPad.this.ta.getSelectionStart()==ta.getSelectionEnd())  
    {  
...
final String helpAboutColourPad="About Javapad";  
